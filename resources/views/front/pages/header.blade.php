<div class="container-fluid bg-dark px-0">
            <div class="row gx-0">
                <div class="col-lg-3 bg-dark d-none d-lg-block">
                    <a href="{{route('front.acceuil')}}" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-9">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        <a href="{{route('front.acceuil')}}" class="navbar-brand d-block d-lg-none">
                            <h1 class="m-0 text-primary text-uppercase">Hotelier</h1>
                        </a>
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                <a href="{{route('front.acceuil')}}" class="nav-item nav-link active">Home</a>
                                <a href="{{route('front.about')}}" class="nav-item nav-link">About</a>
                                <a href="{{route('front.services')}}" class="nav-item nav-link">Services</a>
                                <a href="{{route('front.rooms')}}" class="nav-item nav-link">Rooms</a>
